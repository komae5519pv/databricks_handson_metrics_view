...
| `sales_daily` | 日別売上 | ~36,500件（2024-2025年） |
| `sales_by_category` | カテゴリ別月次売上 | ~8,400件 |
| `prescription_monthly` | 調剤月次実績 | ~720件（調剤併設店のみ） |
...
| sales_date | DATE | 売上日（2024-01-01〜2025-12-31） |
